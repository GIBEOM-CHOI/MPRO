...
<head>
  ...
  <link rel="stylesheet" href="/mpro/asset/css/mypage_edit.css">
</head>
<body>
	<div class="header">
  ...
  <div class="mypage login">
    ...
    <form action="/mpro/member/member_mod_c.do" method="post">
      ...
      <div class="login_mg">
        <div>비밀번호</div>
        <input type="password" name="pw" value="${ member.password }">
      </div>
      ...
      <div class="edit_bt">
        <input type="button" value="회원탈퇴" onclick="location.href='/mpro/member/member_delte.do'" style="width:325px;"></input>
      </div>

      <div class="edit_bt">
        <input type="button" value="마이페이지" onclick="location.href='/mpro/member/mypage.do'"></input>
        <input type="submit" value="회원정보수정"></input>
      </div>
    </form>
  </div>
