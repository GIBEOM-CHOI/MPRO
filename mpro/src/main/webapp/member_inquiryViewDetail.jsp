...
<body>
	<div class="header">
	  ...
	  <section id="reviewContainer">
		...
		<br><br>
		<c:if test="${fn:contains(id, 'member')}"><a href="/mpro/inquiry/member_inquiryView.do" style="text-align:center"><h2>문의내역으로 가기</h2></a></c:if>
		<c:if test="${fn:contains(id, 'seller')}"><a href="/mpro/seller/inquiry.do" style="text-align:center"><h2>문의내역으로 가기</h2></a></c:if>
		</section>
