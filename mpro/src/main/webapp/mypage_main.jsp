...
<body>
  ...
  <div class="menu_sec">
	...
	<div class="mypage">
	    ...
	    <div class="my_menu">
	    	<a href="/mpro/member/member_mod.do">회원정보수정</a>
	    	<a href="/mpro/member/cart_list.do">장바구니</a>
	
	    </div>
	
	    <div class="my_menu">
	    	<a href="/mpro/member/order_list.do">주문내역</a>
	    	<a href="/mpro/inquiry/member_inquiryView.do">문의내역</a>
	    </div>
	
	    <div class="my_menu">
	      <a class="back" href="/mpro/shop/main.do">돌아가기</a>
	    </div>
	</div>
    ...
    <div class="footer_sec">
      ...
      <div class="information">
        ...
        <div class="copy_and_icon">
          ...
          <ul class="icons">
            <a href="#" target="blank"><img src="/mpro/asset/img/home.png" alt="공식홈"></a>
            <a href="#" target="blank"><img src="/mpro/asset/img/insta.png" alt="인스타"></a>
            <a href="#" target="blank"><img src="/mpro/asset/img/facebook.png" alt="페이스북"></a>
          </ul>
        </div>
      </div>
