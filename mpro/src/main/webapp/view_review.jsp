...
<body>
  ...
  <div class="mypage login">
    ...
    <div class="edit_bt">
    	<input type="button" value="수정하기" onclick="location.href='/mpro/review/requestEdit.do?review_id=${reviewDTO.review_id}';"></input>
    	<input type="button" value="삭제하기" onclick="location.href='/mpro/review/requestDelete.do?review_id=${reviewDTO.review_id}';"></input>
    </div>
