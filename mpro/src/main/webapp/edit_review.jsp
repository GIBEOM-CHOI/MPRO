...
<body>
  ...
  <div class="header">
    ...
    <!-- 로고 -->
    <div class="logo_sec">
      <a href="#"><img class="logo" src="asset/img/logo.png" alt="로고"></a>
    </div>
  ...
  <div class="mypage login">
	...
	<form action="/mpro/review/insertReview.do" method="post">
    <div class="write_sec">
      <span>제목</span>
      	<input type="text" name="title" placeholder="리뷰 제목을 입력해 주세요.">
    </div>

    <div class="write_sec_2">
      <span>내용</span>
		<input type="text" name="content" placeholder="리뷰 내용을 입력해 주세요.">
    </div>

    <div class="edit_bt">
      <input type="hidden" name="code" value="${ reviewDTO.code }">
  ...
  <div class="footer">
    <div class="footer_sec">
      ...
      <div class="logo_and_mall">
        <div>
          <img class="footer_logo" src="asset/img/footer_logo.png" alt="하단로고">
        </div>
      ...
      <div class="information">
        ...
        <div class="copy_and_icon">
          ...
          <ul class="icons">
            <a href="#" target="_blank"><img src="asset/img/home.png" alt="공식홈"></a>
            <a href="#" target="_blank"><img src="asset/img/insta.png" alt="인스타"></a>
            <a href="#" target="_blank"><img src="asset/img/facebook.png" alt="페이스북"></a>
          </ul>
        </div>
      </div>
