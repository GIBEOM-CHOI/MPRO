...
<body>
  ...
  <div class="main_banner">
    <a href="#"><img src="/mpro/asset/img/main_banner.png" alt="메인이벤트"></a>
  </div>
    ...
    <table style="margin: auto; margin-top: 100px;">
      <tr>
      	<c:forEach var="i" begin="0" end="3">
        	<th><a href="/mpro/shop/detail.do?code=${ upper[i] }_${ sub[i] }_${ num[i] }"><img src="${ product[i].representative }" alt="${ product[i].code }" style="width:250px;height:250px;"></a></th>
        </c:forEach>
      </tr>

      <tr>
      	<c:forEach var="i" begin="0" end="3">
        	<td>${ product[i].name } <br> ₩ ${ product[i].price } </td>
        </c:forEach>
      </tr>
    </table>
  </div>
